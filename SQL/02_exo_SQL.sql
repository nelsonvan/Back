...
SELECT num_chambre, num_clien FROM reservation WHERE date_arrive = '2019-03-04';
-- Les numéros des chambres coûtant au minimum 80 Euro ayant des lit double et volant au maximum 120 Euro.
SELECT num_chambre FROM chambres WHERE confort LIKE 'lit double' AND prix BETWEEN 80 and 300;
SELECT num_chambre FROM chambres WHERE confort LIKE 'lit double' AND prix >= 80 <=300;
...
SELECT nom, prenom, adresse FROM clients WHERE nom LIKE '%';
