...
<body>
    <div class="container">
        ...
        <form method="post" action="">
            ...
            <br>
        <input type="submit" value="filter" id="submit" class="col-md-6 offset-md-3 btn btn-dark">
        </form>
        <br>

        <!-- 1. Réaliser un selecteur en php qui  regroupe tout les prenom des employés -->
